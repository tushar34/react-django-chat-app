...
import { w3cwebsocket as W3CWebSockect} from 'websocket';
...
client = new W3CWebSockect('ws://127.0.0.1:8000/ws/chat/' + this.state.room + '/');
...
componentDidMount() {
  ...
  {this.state.isLoggedIn ?
          <div style={{ marginTop: 50, }}>
            ...
            <span>Room Name: {this.state.room}</span>
            <span style={{ marginLeft:'20px' }}>User Name:{this.state.name}</span>
